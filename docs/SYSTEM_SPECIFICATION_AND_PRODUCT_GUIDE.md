...
| Конкурент | Ключевые фичи | Слабые места конкурента | Наши преимущества |
|-----------|---------------|--------------------------|------------------------------|
| **Skillaz** | 1000+ клиентов, широкая партнёрская сеть | ❌ Отсутствие AI-скрининга<br>❌ Только текстовые чат-боты<br>❌ Нет голосового канала | ✅ **AI-first:** голосовой пайплайн, адаптивный диалог<br>✅ Автоматический скрининг |
| **MagicSearch** | Глубокое ML-сопоставление резюме и вакансий | ❌ Только текстовый интерфейс<br>❌ Нет голосового канала<br>❌ Не подходит для масс-обзвона | ✅ **Voice-native:** телефон + мессенджеры<br>✅ Полная голосовая автоматизация |
| **CleverStaff** | Интеграция с Telegram-ботами для найма | ❌ Не оптимизирован для масс-найма (>50 позиций)<br>❌ Нет AI-агентов | ✅ **Масштаб:** 1000+ параллельных сессий<br>✅ Масс-найм как основная специализация |
| **InHouse** | Ориентация на масс-найм (курьеры, промоутеры) | ❌ Отсутствие AI-агентов<br>❌ Ручной обзвон<br>❌ Нет автоматизации воронки | ✅ **Полная автоматизация:** 5 агентов от скрининга до онбординга<br>✅ Без участия HR |
| **HireVue** | Видеоинтервью с анализом речи и мимики | ❌ Не соответствует 152-ФЗ<br>❌ Нет российских каналов (MAX, VK)<br>❌ Данные уходят за рубеж | ✅ **Локализация:** 152-ФЗ, MAX/Telegram/VK<br>✅ On-premise опция<br>✅ Данные только в РФ |
| **Paradox (Olivia)** | Чат-бот для планирования собеседований | ❌ Нет голосового канала<br>❌ Не подходит для масс-найма<br>❌ Только текстовый чат | ✅ **Мультиагентность:** LangGraph + голосовой пайплайн<br>✅ 5 специализированных агентов |
