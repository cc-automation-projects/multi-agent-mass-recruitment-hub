...
**Контекст:** `src/agent/[orchestrator.py](../src/agents/orchestrator.py)` — оркестратор на LangChain.
...
**Контекст:** `src/agent/[orchestrator.py](../src/agents/orchestrator.py)` — оркестратор агентов.
**Связанные термины:** AI-агент, ReAct.
